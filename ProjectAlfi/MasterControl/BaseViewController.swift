...
//    func prepareDownButton() {
//        downButton = IconButton(image: Icon.cm.arrowDownward)
//        downButton.tintColor = UIColorFromRGB(rgbValue: 0xFCFCFA)
//        downButton.addTarget(self, action: #selector(HomeViewController.buttonClicked(_:)), for: .touchUpInside)
//    }
    ...
    func prepareMenuButton() {
        ...
        menuButton.addTarget(self, action: #selector(MasterViewController.buttonClicked(_:)), for: .touchDown)
    }
    ...
    func prepareBackButton() {
        ...
        backButton.tintColor = UIColorFromRGB(rgbValue: 0x212121)
        //        backButton.addTarget(self, action: #selector(ProfileViewController.buttonClicked(_:)), for: .touchUpInside)
    }
    ...
    func gotoMainScene(){
        ...
        let appNavigationDrawerController: AppNavigationDrawerController =  AppNavigationDrawerController(rootViewController: appNavController, leftViewController: leftViewController, rightViewController: nil)
